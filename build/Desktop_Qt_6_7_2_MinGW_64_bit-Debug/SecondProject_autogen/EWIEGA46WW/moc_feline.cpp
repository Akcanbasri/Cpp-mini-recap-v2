...
struct qt_meta_stringdata_CLASSFelineENDCLASS_t {};
constexpr auto qt_meta_stringdata_CLASSFelineENDCLASS = QtMocHelpers::stringData(
    "Feline"
);
...
Q_CONSTINIT static const uint qt_meta_data_CLASSFelineENDCLASS[] = {
...
Q_CONSTINIT const QMetaObject Feline::staticMetaObject = { {
    QMetaObject::SuperData::link<Mammal::staticMetaObject>(),
    qt_meta_stringdata_CLASSFelineENDCLASS.offsetsAndSizes,
    qt_meta_data_CLASSFelineENDCLASS,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_stringdata_CLASSFelineENDCLASS_t,
        // Q_OBJECT / Q_GADGET
...
void *Feline::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_CLASSFelineENDCLASS.stringdata0))
